#!/usr/bin/env bash
# The chained voice probe — Deepgram + Gemini + ElevenLabs, the latency A/B twin of voice.sh.
...
exec uv run --extra realtime --extra embed python scripts/chain_probe.py "$@"
