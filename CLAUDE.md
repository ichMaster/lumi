...
```
/core           # canon, per-user memory + shared experience, llm (thin LLMClient seam — Claude Haiku v0.1; more models v0.10), emotion field + validation, mood/temperament (astro engine — skyfield, v0.6), repository interface (user-scoped)
