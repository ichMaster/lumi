...
class TickService:
    ...
    call**) — the home of the future `%update_state` (v1.7 needs / v1.9 inner-life: a split-invariant
    ...
    **collapses to one run** (a re-entrant tick is skipped, never queued); a missed tick is a **no-op**
    ...
    v1.7 just calls :meth:`register` with its callback — this ships the mechanism + the seam.
    """
