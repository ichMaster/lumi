...
v1.6 this is refactored into a server client calling the same contract.
"""
...
class LumiApp(App[None]):
    ...
    def on_mount(self) -> None:
        ...
        if cfg.scheduler:
            ...
            # The fast tick service (LUMI-168): ephemeral code handlers (v1.6 registers %update_state).
    ...
    def register_tick(self, name: str, handler) -> None:
        ...
        callback (no `Thought`, no model call). The seam v1.6 uses for `%update_state`; a no-op if the
