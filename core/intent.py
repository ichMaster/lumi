...
INTENTS: tuple[str, ...] = (
    ...
    "mutate",     # уява — повернути тему боком одним «а що якщо…» (навпаки/масштаб/деінде/схрестити)
    "switch",     # переключити — за настроєм: чесно не хоче про його тему, закриває і пропонує свою
)
