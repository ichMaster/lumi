...
VIEW_TOOLS: list[dict] = [
    {
        ...
        "description": (
            ...
            "ВАЖЛИВО: коли користувач називає файл-картинку (напр. «chat.png» чи «глянь kiln-303.png»), "
            "це файл у твоїй пісочниці — ВІДКРИЙ його цим інструментом за назвою. У цьому текстовому "
            "інтерфейсі картинку не можна «прикріпити», тож ніколи не вважай, що зображення «не долетіло» "
            "чи відсутнє — просто виклич view_image з цією назвою."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "path": {"type": "string", "description": (
                    "Назва файлу-зображення (коротка назва теж працює — знайдеться в art/ і будь-де в пісочниці)."
                )},
            },
            "required": ["path"],
        },
