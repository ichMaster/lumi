...
1. **Routing reads the user's message — never her state.** Her mood/needs color *how* she speaks
   (v0.6/v1.10); they must never decide *which brain* answers — that would make her competence
...
talking = "claude-sonnet-5"          # v1.6 roles
...
**v1.6 — Model roles: register-routed replies**, after the v0.41 profiles it extends and the v0.42
