...
- **v1.6 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v1.7 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v1.3–v1.4** writes her own days (session-start); this writes you (session-close) |
...
## v1.6 — The session-close diary generator
...
**v1.6 + v1.7 — Emotional memory**, right after the inner-life and monologue layers (v1.1–v1.5). Depends on **v0.3**
