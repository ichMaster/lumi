...
- **v0.22 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v0.23 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v0.19–v0.20** writes her own days (session-start); this writes you (session-close) |
...
## v0.22 — The session-close diary generator
...
**v0.22 + v0.23 — Emotional memory**, right after the inner-life and monologue layers (v0.19–v0.21). Depends on **v0.3**
