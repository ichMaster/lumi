...
- **v1.15 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v1.16 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v1.12–v1.13** writes her own days (session-start); this writes you (session-close) |
...
## v1.15 — The session-close diary generator
...
**v1.15 + v1.16 — Emotional memory**, right after the inner-life and monologue layers (v1.10–v1.14). Depends on **v0.3**
