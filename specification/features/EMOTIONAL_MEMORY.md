...
- **v1.4 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v1.5 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v1.1–v1.2** writes her own days (session-start); this writes you (session-close) |
...
## v1.4 — The session-close diary generator
...
**v1.4 + v1.5 — Emotional memory**, right after the inner-life and monologue layers (v1.1–v1.3). Depends on **v0.3**
