...
- **v1.14 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v1.15 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v1.11–v1.12** writes her own days (session-start); this writes you (session-close) |
...
## v1.14 — The session-close diary generator
...
**v1.14 + v1.15 — Emotional memory**, right after the inner-life and monologue layers (v1.9–v1.13). Depends on **v0.3**
