...
- **v1.12 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v1.13 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v1.9–v1.10** writes her own days (session-start); this writes you (session-close) |
...
## v1.12 — The session-close diary generator
...
**v1.12 + v1.13 — Emotional memory**, right after the inner-life and monologue layers (v1.7–v1.11). Depends on **v0.3**
