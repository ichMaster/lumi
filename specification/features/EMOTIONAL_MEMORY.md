...
- **v2.7 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v2.8 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v2.4–v2.5** writes her own days (session-start); this writes you (session-close) |
...
## v2.7 — The session-close diary generator
...
**v2.7 + v2.8 — Emotional memory**, right after the inner-life and monologue layers (v2.2–v2.6). Depends on **v0.3**
