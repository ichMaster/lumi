...
- **v0.16 — Impressions:** the impressions layer + the session-close diary generator + two-layer
  injection.
- **v0.17 — Fading & consolidation:** weight decay + merging small impressions into
...
| pairs with the inner life | **v0.13–v0.14** writes her own days (session-start); this writes you (session-close) |
...
## v0.16 — The session-close diary generator
...
**v0.16 + v0.17 — Emotional memory**, right after the inner life (v0.13–v0.14). Depends on **v0.3**
