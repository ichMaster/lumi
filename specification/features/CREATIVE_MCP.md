...
- **Mood:** the track's mood comes from Лілі's current **emotion field** (`emotion`, `intensity`) and her **mood of the day** (the v0.8 temperament) — calm, playful, tender, and so on.
