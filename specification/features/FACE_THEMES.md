...
- **Intensity:** v0.7 used it to pick `_low`/`_high`; here variety is the chosen axis, so
  ...
  optional refinement, not part of v0.9's must-have.)
...
**v0.9 — Face variants & mood themes**, right after the v0.7 viewer: variety + a wardrobe that
