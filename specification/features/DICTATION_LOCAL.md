...
Four independent pieces around the core, coupled by a few files: the TUI, the dictator (voice in, v0.22), the voicer (voice out, v0.14), and the core.
