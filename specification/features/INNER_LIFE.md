...
> **v1.1** they exist on the v0.43 tick (evolve, feed the mood, lift from warmth); in **v1.2** a
...
hungriest need the plan folds in), **v0.43** (the tick that drives boundaries), **v0.6** (mood),
