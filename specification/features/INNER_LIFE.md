...
- **v0.13 — Inner life I (plans & state):** the three planning layers + boundaries + the global
  store + the state block (she *carries* intentions).
- **v0.14 — Inner life II (away-gap):** the gap-fill (activities/memories/dreams), mood
...
> drives that *pull* her from inside) — woven into the same two phases: in **v0.13** they exist,
> decay, feed the mood + tilt the plan; in **v0.14** they **close** from what she actually did in
...
**v0.13 + v0.14 — Inner life**, right after closeness (v0.10). Depends on **v0.6** (mood),
