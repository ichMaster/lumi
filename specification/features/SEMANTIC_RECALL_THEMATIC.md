...
- **`topics`** — the tuple of topic names this record (message, or chunk under v0.30) is assigned to,
  ...
  (and v1.14 thought vectors) keep an empty `topics`.
...
## Composition with the other vector kinds (v0.36 facts, v1.14 thoughts)

The store also holds `kind="fact"` vectors (v0.36) and, once v1.14 lands, `kind="thought"` vectors.
...
**v1.15 — Semantic recall V: thematic recall (topic routing)**, a refinement of the recall line
