...
- **`topics`** — the tuple of topic names this record (message, or chunk under v0.30) is assigned to,
  ...
  (and v0.42 thought vectors) keep an empty `topics`.
...
## Composition with the other vector kinds (v0.36 facts, v0.42 thoughts)

The store also holds `kind="fact"` vectors (v0.36) and, once v0.42 lands, `kind="thought"` vectors.
...
**v0.43 — Semantic recall V: thematic recall (topic routing)**, a refinement of the recall line
