...
physical-world claim about herself — the v1.6 honesty boundary holds in the thought stream as it does in a
reply.
...
- **Mostly silent** — her diary is private; it defaults to **rare** surfacing (an occasional quiet "записала
  ...
  never a physical-world claim about herself (the v1.6 boundary). Off unless `LUMI_THOUGHTS` **and**
  `LUMI_JOURNAL` are on.
...
- **Untrusted + honest about nature.** What she reads is external **untrusted data** (never
  ...
  cited) — never as innate certainty and never as a physical-world claim about herself (the v1.6 honesty
  boundary).
