...
| long-term: facts + impressions (v1.8) | durable understanding | not verbatim, not exhaustive |
...
(v1.5–v1.9) — the exact-recall complement to those lossy layers, built first because its only
