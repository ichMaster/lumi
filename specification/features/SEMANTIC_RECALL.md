...
| long-term: facts + impressions (v1.9) | durable understanding | not verbatim, not exhaustive |
...
(v1.6–v1.10) — the exact-recall complement to those lossy layers, built first because its only
