...
- **`core/inner_voice.md` v2:** the retrospective (last 2 tagged replies: intent vs execution vs user reaction — dry binary questions, no self-shaming tone), move-typed voices, the arbiter + its rule table.
